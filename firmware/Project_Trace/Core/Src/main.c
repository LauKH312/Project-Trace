...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, Disp_CS_Pin|Disp_RES_Pin|Disp_DC_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(SPI1_SYNC_GPIO_Port, SPI1_SYNC_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, Range_att_40db_Pin|Range_att_20db_Pin|V_A_meter_Pin|ACCoupleEnable_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, Range_gain_20db_Pin|Range_att_0db_Pin|CLK_EN_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : Disp_CS_Pin Disp_RES_Pin Disp_DC_Pin */
  ...
  /*Configure GPIO pins : Range_att_40db_Pin Range_att_20db_Pin V_A_meter_Pin ACCoupleEnable_Pin */
  GPIO_InitStruct.Pin = Range_att_40db_Pin|Range_att_20db_Pin|V_A_meter_Pin|ACCoupleEnable_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
